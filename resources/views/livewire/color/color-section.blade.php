...
<div x-data="{showUpdatebtn:false}">
    ...
    <form 
        ...
        <div>
            ...
            <x-input type="text" id="size" class="form-input rounded-md" wire:model.defer="color"/>

        <button type="submit" x-sh
        ow="!showUpdatebtn" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
        ...
        Register
          ...
          <x-button type="button" x-show="showUpdatebtn" wire:click="update">Update</x-button>
        @error('color')
...
<table class="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-800 text-gray-200" wire:poll='fetch'>
