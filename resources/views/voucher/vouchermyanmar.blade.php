...
<body class="bg-white">
    <div class="max-w-7xl px-4 py-6 sm:px-6 lg:px-8 bg-white shadow">
      <div class="relative inline-block mb-4">
            <h1 class="text-4xl">စုဝတီ</h1>
            <h3 class="absolute" style="right:-120px;bottom:0px;" >paper production</h3>
      </div>
       <p class="mb-2">Address-အမှတ် (၂၈၁၅) ရွှေလီလမ်း, ၆၃ ရပ်ကွက်, စက်မှုဇုန် (၂), တောင်ဒဂုံမြို့နယ်</p>
<p class="inline-block ">Phone-Number(1):095115176</p>
<p class="inline-block ">Phone-Number(2):09452541030</p>
